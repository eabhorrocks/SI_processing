...
%% User input: 
UMparam.SaveDir = 'C:\Users\adam.tong\Documents\Mouse2\JF067\ExampleOutput'; % Recommended to use end this path with \Probe0\IMRO_1\ if more probes/IMRO tables were used or \AllProbes\AllIMRO\ otherwise
mkdir(UMparam.SaveDir)
UMparam.KSDir = {'C:\Users\adam.tong\Documents\Mouse2\JF067\2022-02-14\Probe0\4','C:\Users\adam.tong\Documents\Mouse2\JF067\2022-02-15\Probe0\5'};  % This is a cell array with a path, in the path there should be a subfolder called 'RawWaveforms'. 
